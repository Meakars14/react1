          ...
          <div className="col-lg-7 col-md-12 left-content">
            <div className="collection-item">
              ...
              <div className="col-lg-6 col-md-6 col-sm-6 product-entry">
                ...
                <p>
                  Streetwear is a fashion style that originated from urban
                  culture and has become a global trend, blending casual,
                  comfortable clothing with bold, graphic designs
                </p>
